  ...
  <div class="control-section">
    ...
    <div class="tablediv" style="font-size:14px; margin-top:20px;">
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-row">
            <label class="e-label">Cryptographic Standard:</label>
          ...
          <div class="form-row">
            <label class="e-label">Digest Algorithm:</label>
            <div class="form-group">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-row">
            <label class="e-label">Signature Type:</label>
            <div class="form-group">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-row">
            <label class="e-label" for="sourceFile">Source</label>
          ...
          <div class="form-row">
            <label class="e-label" for="certFile">Certificate</label>
          ...
          <div class="form-row">
            <label class="e-label" for="certPassword">Password</label>
            <input type="password" id="certPassword" placeholder="Password" />
          </div>
          <div class="form-row">
            <label class="e-label" for="reason">Reason</label>
            <input type="text" id="reason" placeholder="Reason" />
          </div>
          <div class="form-row">
            <label class="e-label" for="contact">Contact</label>
            <input type="text" id="contact" placeholder="Contact" />
          </div>
          <div class="form-row">
            <label class="e-label" for="location">Location</label>
...
<style scoped>
    ...
    .e-bigger.e-touch .control-section #createSignBtn.e-btn {
...
export default defineComponent({
  ...
  setup() {
    onMounted(() => {
      // Initialize global EJ2 widgets if the CDN/global script is present
      try {
        const ej = (window as any).ej;
        if (ej) {
          const btns = ej.buttons;
          const inputs = ej.inputs;
          if (btns && btns.RadioButton) {
            try { new btns.RadioButton({ name: 'cryptoStandard', checked: true }, '#crypto_CMS'); } catch {}
            try { new btns.RadioButton({ name: 'cryptoStandard' }, '#crypto_CAdES'); } catch {}
            try { new btns.RadioButton({ name: 'digestAlgo' }, '#digest_SHA1'); } catch {}
            try { new btns.RadioButton({ name: 'digestAlgo', checked: true }, '#digest_SHA256'); } catch {}
            try { new btns.RadioButton({ name: 'digestAlgo' }, '#digest_SHA384'); } catch {}
            try { new btns.RadioButton({ name: 'digestAlgo' }, '#digest_SHA512'); } catch {}
            try { new btns.RadioButton({ name: 'digestAlgo' }, '#digest_RIPEMD160'); } catch {}
            try { new btns.RadioButton({ name: 'signatureType', checked: true }, '#sig_Standard'); } catch {}
            try { new btns.RadioButton({ name: 'signatureType' }, '#sig_Author'); } catch {}
          }
          if (btns && btns.Button) {
            try { new btns.Button({}, '#createSignBtn'); } catch {}
            try { new btns.Button({}, '#signExistingBtn'); } catch {}
            try { new btns.Button({}, '#sourceFileBtn'); } catch {}
            try { new btns.Button({}, '#certFileBtn'); } catch {}
          }
          if (inputs && inputs.TextBox) {
            try { new inputs.TextBox({}, '#certPassword'); } catch {}
            try { new inputs.TextBox({}, '#reason'); } catch {}
            try { new inputs.TextBox({}, '#contact'); } catch {}
            try { new inputs.TextBox({}, '#location'); } catch {}
          }
          const src = document.getElementById('sourceFile');
          const srcName = document.getElementById('sourceFileName');
          if (src && srcName) {
            src.addEventListener('change', function (this: HTMLInputElement) {
              const f = (this.files && this.files.length) ? this.files[0].name : 'No file chosen';
              srcName.textContent = f;
            });
          }
          const cert = document.getElementById('certFile');
          const certName = document.getElementById('certFileName');
          if (cert && certName) {
            cert.addEventListener('change', function (this: HTMLInputElement) {
              const f = (this.files && this.files.length) ? this.files[0].name : 'No file chosen';
              certName.textContent = f;
            });
          }
        }
      } catch (e) {
        console.warn('EJ2 init skipped or failed:', e);
      }
