<template>
  <div>
    <div class="control-section">
      ...
      <div class="button-section" style="margin-left: 15px; margin-top: 20px;">
        <div id="button-control">
          <div class="row">
            <input type="submit" id="normalbtn" class="e-btn" value="Generate PDF" style="width: 150px; text-transform:capitalize" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="description">
      <p>It is also possible to draw Unicode text. More information about RTL text drawing can be found in this
          documentation <a
              href="https://help.syncfusion.com/document-processing/pdf/pdf-library/javascript/text#drawing-right-to-left-text">section</a>.
      </p>
    </div>
  </div>
</template>
