<template>
  <div>
    <div class="control-section">
      ...
      <div class="button-section" style="margin-left: 15px; margin-top: 20px;">
        <div id="button-control">
          <div class="row">
            <input type="submit" id="shapebtn" class="e-btn" value="Generate PDF" style="width: 150px; text-transform:capitalize" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="description">
        <p>This feature allows you to render and customize shapes within specified bounds. More information about shapes
            drawing can be found in this documentation <a
                href="https://help.syncfusion.com/document-processing/pdf/pdf-library/javascript/shapes">section</a>.
        </p>
    </div>
  </div>
</template>
